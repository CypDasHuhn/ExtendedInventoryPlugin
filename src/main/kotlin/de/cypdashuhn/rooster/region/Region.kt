...
class Region(
    ...
    val doubleMinX: Double by lazy { minX.toDouble() }
    val doubleMinY: Double by lazy { minY.toDouble() }
    val doubleMinZ: Double by lazy { minZ.toDouble() }
    val doubleMaxX: Double by lazy { maxX.toDouble() }
    val doubleMaxY: Double by lazy { maxY.toDouble() }
    val doubleMaxZ: Double by lazy { maxZ.toDouble() }
    ...
    fun edges(): List<Location> {
        return listOf(
            Location(world, doubleMinX, doubleMinY, doubleMinZ),
            Location(world, doubleMaxX, doubleMinY, doubleMinZ),
            Location(world, doubleMinX, doubleMaxY, doubleMinZ),
            Location(world, doubleMaxX, doubleMaxY, doubleMinZ),
            Location(world, doubleMinX, doubleMinY, doubleMaxZ),
            Location(world, doubleMaxX, doubleMinY, doubleMaxZ),
            Location(world, doubleMinX, doubleMaxY, doubleMaxZ),
            Location(world, doubleMaxX, doubleMaxY, doubleMaxZ)
        )
    }
